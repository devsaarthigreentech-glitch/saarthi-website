...
<br></br>
          ...
          {/* <p className="mt-6 text-lg text-slate-700 dark:text-white/90">
            ...
            easy-to-install retrofits, measurable fuel savings, and auditable
            reporting via GreenVision.
          </p> */}
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              href="/solutions"
              className="inline-flex items-center justify-center rounded-full px-6 py-3 font-medium border border-slate-300 text-slate-900 hover:bg-slate-50 dark:border-white/30 dark:text-white dark:hover:bg-white/10"
            >
              See Our Solutions
            </Link>
            ...
            <a
              href="/overview.pdf"
              className="inline-flex items-center justify-center px-4 py-3 text-sm text-slate-700 underline dark:text-white/80 hover:opacity-80"
            >
          ...
          {/* <div className="mt-8 flex items-center gap-4 overflow-x-auto">
            <div className="text-slate-600 dark:text-white/70 text-sm mr-2">
              Trusted by:
            </div>
