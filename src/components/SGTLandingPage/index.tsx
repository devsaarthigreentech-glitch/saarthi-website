    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {/* GreenMentor */}
            <a href="/greenmentor" className="relative bg-white rounded-2xl p-8 border-2 border-gray-200 hover:border-sgt-green hover:shadow-xl transition-all cursor-pointer group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Plant assessment, combustion system analysis, custom solution design, and implementation roadmap
              </p>
            ...
            {/* GreenLabs */}
            <a href="/greenlabs" className="relative bg-white rounded-2xl p-8 border-2 border-gray-200 hover:border-sgt-yellow hover:shadow-xl transition-all cursor-pointer group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Custom manufacturing of CHFA/CHCA systems, installation, commissioning, and operator training
              </p>
            ...
            {/* GreenVision */}
            <a href="/greenvision" className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:border-gray-400 hover:shadow-xl transition-all cursor-pointer group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Real-time performance monitoring, predictive maintenance alerts, and continuous optimization support
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Profitable Decarbonisation for Industry, Marine & Logistics
              </p>
            </div>
