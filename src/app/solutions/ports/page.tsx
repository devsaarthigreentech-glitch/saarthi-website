...
const FleetSolutionsPage = () => {
    ...
    const heroImageUrl = "/images/solutions/ports-hero.jpg"; 

    return (
        <main className="min-h-screen font-sans" style={{ backgroundColor: BG_LIGHT }}>

            {/* 1. Header / Hero Section (Redesigned: Dark Mode Style & Smaller Height) */}
            <section 
                className="relative text-center overflow-hidden"
                style={{
                    // Use a dark gradient over the image
                    backgroundImage: `linear-gradient(rgba(15, 23, 42, 0.5), rgba(15, 23, 42, 0.75)), url(${heroImageUrl})`,
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    borderBottom: `4px solid ${PRIMARY_COLOR}`
                }}
            >
                {/* Reduced padding here: py-20 for mobile, md:py-32 for desktop */}
                <div className="relative py-20 md:py-32 container mx-auto px-4 max-w-7xl relative z-10 text-white">
                    <p className="text-sm font-bold tracking-widest uppercase mb-4" style={{ color: PRIMARY_COLOR }}>
                        Solutions for Ports & Terminals
                    </p>
                    <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-white">
                        Fuel Transition for Port Efficiency <br className="hidden md:block" /> and Sustainability
                    </h1>
                    <p className="text-lg md:text-xl mb-10 max-w-3xl mx-auto font-light text-gray-200 opacity-90">
                        Implementing Dual Fuel technology in RTGs, RMGs, and Port Equipment achieves significant cost savings and compliance with global green port initiatives.
                    </p>
                    <div className="flex flex-wrap justify-center gap-4">
                        <a 
                            href="#technology" 
                            className="px-8 py-3 text-lg font-bold rounded-full shadow-lg transition-all duration-300 transform hover:scale-[1.05] hover:shadow-2xl"
                        ...
                        <a 
                            href="/contact" 
                            className="px-8 py-3 text-lg font-bold rounded-full border-2 border-gray-400 hover:bg-white hover:text-gray-900 transition-all duration-300 transform hover:scale-[1.05] text-white"
                        >
                            Get a Custom Quote
                        </a>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl mb-8 font-semibold" style={{ color: TEXT_DARK }}>
                                Key Technological Advantages:
                            </p>
                            <ul className="space-y-4" style={{ listStyle: 'none', padding: 0 }}>
                                <BenefitListItem>Intelligent Substitution: The system automatically and dynamically optimizes the gas-diesel ratio (up to 70% gas substitution) based on real-time engine load to maximize efficiency and safety.</BenefitListItem>
                                <BenefitListItem>Non-Invasive Installation: The conversion is external to the engine block, preserving the original diesel engine warranty and core integrity.</BenefitListItem>
                                <BenefitListItem>High Reliability: Maintains 100% torque and power output required for continuous, heavy-duty port lifting operations.</BenefitListItem>
                            </ul>
                        </div>
                        {/* Placeholder for technology diagram/image */}
                        <div className="bg-gray-100 p-8 rounded-xl shadow-inner flex flex-col items-center justify-center min-h-[400px]">
                            <p className="text-gray-500 text-center mb-4">
                                <img src="/images/solutions/fuel-tech.png" alt="Dual Fuel Technology Diagram" className="max-w-full h-auto rounded-lg shadow-md" />
                            </p>
                            {/* <a 
                                href="/technology-deep-dive" 
                                className="inline-flex items-center text-lg font-semibold mt-4 px-6 py-3 rounded-full border border-blue-600 text-blue-600 hover:bg-blue-50 transition-all duration-300"
                            >
