...
//                     </h2>
//                 </header> */}
//                 <header className="py-20 bg-slate-900 text-white">
//         <div className="container mx-auto px-6 text-center">
//           <p className="mt-3 text-slate-200 max-w-2xl mx-auto">
//             Our Foundation
//           </p>
//           <h1 className="text-3xl md:text-4xl font-extrabold">The Founder's Story</h1>
//         </div>
//       </header>
...
const FounderStory = () => {
  ...
  return (
    <>
      ...
      {/* ===== MAIN CONTENT ===== */}
      <section className="bg-white dark:bg-gray-900 py-16 md:py-24 text-gray-800 dark:text-gray-200">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-2 space-y-8 text-lg leading-relaxed">
              ...
              <section className="p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 shadow">
                ...
                <p>
                  His journey traces back to Varanasi, where resilience, humility,
                  and perseverance shaped his worldview. Engineering and management
                  education helped blend technical insight with strategic thinking.
                </p>
              </section>

              <section className="space-y-4">
                <h4 className="text-2xl font-bold border-b pb-2">
              ...
              <section className="p-6 rounded-2xl border-l-4" style={{ borderColor: brandColor }}>
                ...
                <p className="italic text-gray-600 dark:text-gray-400 mt-3">
                  The result: a working system capable of reducing emissions and
                  improving fuel efficiency across diesel engines of any size.
                </p>
              </section>
              ...
              <div className="pt-6 border-t">
                <h4 className="text-2xl font-extrabold mb-4">
                  Alok’s vision is clear:
                </h4>
                <ul className="space-y-3 text-xl font-medium">
                  <li>• Sustainability must be engineered and scalable</li>
                  <li>• Leadership must outlive the founder</li>
                </ul>
              </div>
