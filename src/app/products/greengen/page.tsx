...
export const metadata = {
  title: "GreenGen — Hydrogen retrofits for generators | Saarthi GreenTech",
  description:
    "GreenGen by Saarthi — retrofit hydrogen systems for 20–4000 kVA generators that reduce emissions and save fuel.",
};

const PRODUCT_SLUG = "greengen";
const PRODUCT_NAME = "GreenGen";
const PRODUCT_DESC =
  "GreenGen by Saarthi GreenTech — retrofit hydrogen systems for 20–4000 kVA generators that reduce emissions and save fuel.";
...
export default function GreenGenPage() {
  return (
    <>
      <Script id="greengen-product-jsonld" type="application/ld+json">
        {JSON.stringify(productJsonLd)}
      </Script>

      <Script id="greengen-breadcrumb-jsonld" type="application/ld+json">
        {JSON.stringify(breadcrumbJsonLd)}
      </Script>

      <main className="min-h-screen bg-white text-slate-900" role="main">
        {/* HERO */}
        <section id="hero" className="relative bg-slate-900 text-white">
          <div className="absolute inset-0 -z-10">
            <div className="relative w-full h-full">
          ...
          <div className="container mx-auto px-6 py-24 md:py-32">
            <div className="max-w-3xl">
              <p className="text-sm font-semibold text-green-300 mb-2">
                GreenGen — The only retrofit that cuts emissions and saves fuel
              </p>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight">
                Cleaner, smarter generators.{" "}
                <span className="text-green-400">One solution for every kVA.</span>
              </h1>
              <p className="mt-6 text-lg text-slate-200/90">
                GreenGen is Saarthi GreenTech’s hydrogen retrofit brand for diesel
                generators (20 kVA → 4000 kVA). It reduces emissions while saving
                fuel — an alternative to bulky post-treatment systems.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-2xl font-extrabold mb-3">The challenge with DG sets</h2>
                <p className="text-slate-600 mb-4">
                  Diesel generators are critical in many sectors (telecom, hospitals,
                  data centers, ports, mining) but are also major polluters and
                  expensive to operate. Conventional post-combustion systems are
                  bulky, costly, and don't reduce fuel consumption.
                </p>
        ...
        <section id="advantage" className="py-16 bg-slate-50">
          <div className="container mx-auto px-6 max-w-6xl">
            <h3 className="text-3xl font-extrabold text-center mb-4">The GreenGen advantage</h3>
            <p className="text-center text-slate-600 max-w-3xl mx-auto mb-8">
              Hydrogen-from-water, metered dosing, compact retrofit and GreenVision
              connectivity — a solution engineered to reduce emissions and save fuel.
            </p>
        ...
        <section id="product-range" className="py-16 bg-white">
          <div className="container mx-auto px-6 max-w-6xl">
            <h3 className="text-3xl font-extrabold text-center mb-4">Product range by generator rating</h3>
            <p className="text-center text-slate-600 max-w-3xl mx-auto mb-8">
              GreenGen supports Small, Medium and Large ratings — every common kVA has a tailored solution.
            </p>
