// src/app/products/GreenX/page.tsx
...
export default function GreenXPage() {
  return (
      ...
      <section id="hero" className="relative bg-slate-900 text-white">
        <div className="absolute inset-0 -z-10">
          <div className="relative w-full h-full">
            <Image
              src="/images/GreenX/hero-dg.png"
              alt="GreenX hero - DG sets glowing green"
              priority
              fill
        ...
        <div className="container mx-auto px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold text-green-300 mb-2">GreenX — The only retrofit that cuts emissions and saves fuel</p>
  ...
  Diesel generators are critical in many sectors (telecom, hospitals, data centers, ports, mining) but are also major polluters and expensive to operate. Conventional post-combustion systems are bulky, costly, and don&apos;t reduce fuel consumption.
      ...
      {/* Section 2: GreenX Advantage */}
      <section id="advantage" className="py-16 bg-slate-50">
        <div className="container mx-auto px-6 max-w-6xl">
          <h3 className="text-3xl font-extrabold text-center mb-4">The GreenX advantage</h3>
      ...
      <section id="product-range" className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <p className="text-center text-slate-600 max-w-3xl mx-auto mb-8">GreenX supports Small, Medium and Large ratings — every common kVA has a tailored solution.</p>
      ...
      <section id="applications" className="py-16 bg-slate-50">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <p className="text-center text-slate-600 max-w-3xl mx-auto mb-8">Where GreenX is applied — telecom, hospitals, industry, ports and more.</p>
            ...
            <table className="w-full table-auto text-left">
              <thead className="bg-slate-50">
                <tr>
                  ...
                  <th className="px-6 py-3">With GreenX</th>
      ...
      <section id="benefits" className="py-16 bg-slate-50">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <p className="text-center text-slate-600 max-w-3xl mx-auto mb-8">Why customers choose GreenX</p>
      ...
      <section id="cta" className="py-20 bg-gradient-to-r from-green-600 to-emerald-500 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-3 text-lg text-white/90">GreenX delivers dual ROI — emissions reduction plus measurable fuel savings.</p>
