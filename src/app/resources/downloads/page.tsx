...
// // // //   title: "Downloads — SGT HydroEdge",
// // // //   description: "Brochures, fact sheets and downloads for SGT HydroEdge",
// // // // };
...
// // // //             Brochures, fact sheets and technical datasheets for SGT HydroEdge products and solutions.
// // // //           </p>
// // // //           <div className="mt-6">
...
// //   LayoutGrid, List, FileText, FolderOpen, Zap,
...
// //     id: "pamphlets",
// //     name: "Pamphlets",
// //     description: "Detailed solution pamphlets with specs",
...
// //     fileCount: 1,
// //     files: [
// //       { name: "SGT CHFA Patent Filing", path: "/downloads/patent/SGT_CHFA_Patent.pdf", size: "2.1 MB", tag: "Technology", tagIcon: <Zap className="w-3 h-3" /> },
// //     ]
// //   },
// //   {
// //     id: "presentations",
// //     name: "Presentations",
// //     description: "Corporate and solution decks",
// //     icon: <LayoutGrid className="w-5 h-5" />,
// //     fileCount: 6,
// //     files: [
// //       { name: "GreenMarine Corporate Deck", path: "/downloads/presentations/GreenMarine_Corp_PPT.pdf", size: "1.9 MB", tag: "Marine", tagIcon: <Ship className="w-3 h-3" /> },
// //       { name: "GreenX DG Presentation", path: "/downloads/presentations/SGT_GreenX_presentation_Jan26.pdf", size: "1.4 MB", tag: "Industrial", tagIcon: <Factory className="w-3 h-3" /> },
// //       { name: "GreenDrive Deck (Feb 2026)", path: "/downloads/presentations/SGT_GreenDrive_Deck_Feb_26.pdf", size: "1.6 MB", tag: "Logistics", tagIcon: <Truck className="w-3 h-3" /> },
// //       { name: "Investor Presentation (Feb 2026)", path: "/downloads/presentations/SGT_Hydroedge_Investor_presentation_Feb26.pdf", size: "2.7 MB", tag: "Corporate", tagIcon: <Zap className="w-3 h-3" /> },
// //       { name: "Decarbonization — Profitably Delivered", path: "/downloads/presentations/SGT_CorpDecarbonization_Profitably_Delivered.pdf", size: "1.9 MB", tag: "Corporate", tagIcon: <Zap className="w-3 h-3" /> },
// //       { name: "Decarbonizing the Present", path: "/downloads/presentations/Decarbonizing_the_Present.pdf", size: "1.7 MB", tag: "Corporate", tagIcon: <Zap className="w-3 h-3" /> },
// //     ]
// //   },
// //   {
// //     id: "research",
...
// //     fileCount: 1,
// //     files: [
// //       { name: "CHFA Research Paper (ARAI Published)", path: "/downloads/research/CHFA_Research_Paper_Revised_v4.pdf", size: "850 KB", tag: "Technology", tagIcon: <Zap className="w-3 h-3" /> },
// //     ]
// //   },
// //   {
// //     id: "technical",
// //     name: "Technical Documents",
// //     description: "Whitepapers and technical briefs",
// //     icon: <Settings className="w-5 h-5" />,
// //     fileCount: 1,
// //     files: [
// //       { name: "Industrial Decarbonisation Whitepaper", path: "/downloads/technical/Industrial_Decarbonisation_1.pdf", size: "162 KB", tag: "Industry", tagIcon: <Factory className="w-3 h-3" /> },
// //     ]
// //   },
// // ];
...
// //   Industrial: "bg-emerald-900/30 text-emerald-400 border-emerald-800/50",
// //   Logistics: "bg-blue-900/30 text-blue-400 border-blue-800/50",
// //   Marine: "bg-cyan-900/30 text-cyan-400 border-cyan-800/50",
// //   Corporate: "bg-gray-700/30 text-gray-300 border-gray-600/50",
// //   Technology: "bg-amber-900/30 text-amber-400 border-amber-800/50",
// //   Industry: "bg-emerald-900/30 text-emerald-400 border-emerald-800/50",
// // };
...
// //         <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-sgt-green/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3" />
// //         <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-sgt-green/3 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/3" />
...
// //               <div className="w-2 h-2 rounded-full bg-sgt-green" />
// //               <span className="text-gray-400">{downloadCategories.length} categories</span>
// //             </div>
// //             <div className="flex items-center gap-2 text-sm">
// //               <div className="w-2 h-2 rounded-full bg-sgt-green" />
// //               <span className="text-gray-400">{totalFiles} documents</span>
// //             </div>
// //             <div className="flex items-center gap-2 text-sm">
// //               <div className="w-2 h-2 rounded-full bg-sgt-green" />
...
// //               if (e.target.value.trim()) setActiveCategory(null);
// //             }}
// //             className="w-full pl-12 pr-4 py-3.5 bg-gray-900 border border-gray-800 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-sgt-green/40 focus:border-sgt-green/50 transition-all"
// //           />
// //         </div>
// //       </div>
...
// //                 key={cat.id}
// //                 onClick={() => setActiveCategory(cat.id)}
// //                 className="group relative bg-gray-900 border border-gray-800 rounded-xl p-6 text-left hover:border-sgt-green/50 hover:bg-gray-900/80 transition-all duration-200"
// //               >
// //                 {/* Top row: icon + count */}
// //                 <div className="flex items-start justify-between mb-4">
// //                   <div className="w-10 h-10 rounded-lg bg-sgt-green/10 border border-sgt-green/20 flex items-center justify-center text-sgt-green">
// //                     {cat.icon}
// //                   </div>
...
// //                 <h3 className="text-white font-semibold mb-1 group-hover:text-sgt-green transition-colors">
// //                   {cat.name}
// //                 </h3>
...
// //                 {/* Arrow */}
// //                 <div className="absolute bottom-6 right-6 w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all group-hover:translate-x-1">
// //                   <ArrowRight className="w-4 h-4 text-sgt-green" />
// //                 </div>
// //               </button>
// //             ))}
// //           </div>
...
// //             <div className="flex items-center gap-4 mb-8">
// //               <div className="w-12 h-12 rounded-xl bg-sgt-green/10 border border-sgt-green/20 flex items-center justify-center text-sgt-green">
// //                 {currentCategory.icon}
// //               </div>
// //               <div>
// //                 <h2 className="text-2xl font-bold text-white">{currentCategory.name}</h2>
// //                 <p className="text-sm text-gray-500">{currentCategory.files.length} document{currentCategory.files.length !== 1 ? "s" : ""}</p>
// //               </div>
// //             </div>
...
// //       {/* ── CTA ── */}
// //       <section className="max-w-7xl mx-auto px-6 pb-20">
// //         <div className="relative overflow-hidden bg-gradient-to-br from-sgt-green/20 to-gray-900 border border-sgt-green/20 rounded-2xl p-10 lg:p-14">
// //           <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-sgt-green/10 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/3" />
...
// //               <Link
// //                 href="/contact"
// //                 className="inline-flex items-center bg-sgt-green text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-all text-sm"
// //               >
...
// //               <Link
// //                 href="/resources"
// //                 className="inline-flex items-center bg-gray-800 border border-gray-700 text-gray-300 px-6 py-3 rounded-lg font-semibold hover:border-gray-600 hover:text-white transition-all text-sm"
// //               >
// //                 Browse All Resources
// //               </Link>
// //             </div>
...
// //   const tagStyle = tagStyles[file.tag] || "bg-gray-700/30 text-gray-300 border-gray-600/50";

// //   return (
// //     <div className="group flex items-center gap-4 bg-gray-900 border border-gray-800 rounded-xl px-5 py-4 hover:border-gray-700 hover:bg-gray-900/60 transition-all">
// //       {/* PDF icon */}
// //       <div className="w-10 h-10 rounded-lg bg-red-950/40 border border-red-900/30 flex items-center justify-center flex-shrink-0">
// //         <span className="text-red-400 text-xs font-bold tracking-wider">PDF</span>
// //       </div>

// //       {/* Info */}
// //       <div className="flex-1 min-w-0">
// //         <h4 className="text-white text-sm font-medium truncate group-hover:text-sgt-green transition-colors">
// //           {file.name}
// //         </h4>
// //         <div className="flex items-center gap-3 mt-1">
...
// //       {/* Tag */}
// //       <div className={`hidden sm:flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full border ${tagStyle}`}>
// //         {file.tagIcon}
// //         {file.tag}
// //       </div>
...
// //           target="_blank"
// //           rel="noopener noreferrer"
// //           className="inline-flex items-center gap-1.5 px-4 py-2 bg-sgt-green/10 border border-sgt-green/30 text-sgt-green text-xs font-semibold rounded-lg hover:bg-sgt-green hover:text-white transition-all"
// //         >
...
// //           href={file.path}
// //           download
// //           className="inline-flex items-center gap-1.5 px-4 py-2 bg-gray-800 border border-gray-700 text-gray-400 text-xs font-semibold rounded-lg hover:bg-gray-700 hover:text-white transition-all"
// //         >
...
//       {/* ── HERO — dark header matching industrial page ── */}
//       <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
//         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-sgt-green/8 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4" />
...
//           <div className="inline-flex items-center px-3 py-1.5 bg-sgt-green/15 border border-sgt-green/25 rounded-full text-sgt-green text-xs font-semibold mb-5">
...
//                     <div className="w-11 h-11 rounded-xl bg-sgt-green/10 flex items-center justify-center text-sgt-green group-hover:bg-sgt-green group-hover:text-white transition-all">
//                       {cat.icon}
//                     </div>
...
//             <div className="flex items-center gap-4 mb-8">
//               <div className="w-12 h-12 rounded-xl bg-sgt-green/10 flex items-center justify-center text-sgt-green">
//                 {currentCategory.icon}
//               </div>
//               <div>
//                 <h2 className="text-2xl font-bold text-gray-900">{currentCategory.name}</h2>
...
//       {/* ── CTA — green gradient matching industrial page ── */}
//       <section className="py-16 bg-white">
//         <div className="max-w-7xl mx-auto px-6">
//           <div className="bg-gradient-to-br from-green-800 to-sgt-green rounded-3xl p-10 lg:p-14 text-center overflow-hidden relative">
...
//                 <Link
//                   href="/contact"
//                   className="inline-flex items-center text-center bg-white text-sgt-green px-8 py-3 rounded-lg text-sm font-bold hover:bg-sgt-yellow hover:text-gray-900 transition-all"
//                 >
...
//   return (
//     <div className="group flex items-center gap-4 bg-gray-50 border border-gray-200 rounded-xl px-5 py-4 hover:border-sgt-green/40 hover:shadow-sm transition-all">
//       {/* PDF badge */}
